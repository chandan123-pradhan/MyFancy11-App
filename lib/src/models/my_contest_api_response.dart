...
class MyContestData {
  ...
  late final String bonusEntry;
  late final String spendEarn;
  late final String duplicate;
  late final WinInfo winInfo;
  late final Null offer;
  ...
  MyContestData.fromJson(Map<String, dynamic> json){
    ...
    winInfo = WinInfo.fromJson(json['win_info']);
    offer = null;
  }
...
class WinInfo {
  ...
  late final String totalWinTeam;
  late final String totalWinAmount;
  
  WinInfo.fromJson(Map<String, dynamic> json){
    totalWinTeam = json['total_win_team'].toString();
    totalWinAmount = json['total_win_amount'].toString();
  }

  Map<String, dynamic> toJson() {
    final _data = <String, dynamic>{};
    _data['total_win_team'] = totalWinTeam;
    _data['total_win_amount'] = totalWinAmount;
    return _data;
  }
}