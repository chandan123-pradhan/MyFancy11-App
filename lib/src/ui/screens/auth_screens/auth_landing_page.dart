        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child:Image.asset(ImageUitls.App_Logo,
              height: 50,
              fit: BoxFit.cover,
              )
            ),
                      ...
                      child: Column(
                        children: [
                          Container(
                            ...
                            child: Center(
                              child: CachedNetworkImage(
                                imageUrl: controller.splashDataApiResponse.loginBanner[i].img,
                                progressIndicatorBuilder:
                                    (context, url, downloadProgress) =>
                                       Image.asset(ImageUitls.Banner2),
                          ...
                          Padding(
                            ...
                            child: Text(
                              "Rady to start winning? Swipe left to learn  the basics of fantacy sports.",
