...
class JoinCotestConfirmationScreen extends StatefulWidget {
  ...
  JoinCotestConfirmationScreen(
      {required this.myTeamId, required this.match, required this.contest});

  @override
  State<JoinCotestConfirmationScreen> createState() =>
      _JoinCotestConfirmationScreenState();
}

class _JoinCotestConfirmationScreenState
    extends State<JoinCotestConfirmationScreen> {
            ...
            return controller.getWalletApiResponse == null
                ...
                : Column(
                    children: [
                      ...
                      //             .getWalletApiResponse!.data.depositWallet)
                      //     ? Column(
                      //         children: [
                      //           Padding(
                      //             padding: const EdgeInsets.only(
