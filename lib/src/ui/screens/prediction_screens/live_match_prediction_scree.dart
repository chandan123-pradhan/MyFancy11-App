...
class LiveMatchPredictionHomePage extends StatefulWidget {
  ...
  @override
  State<LiveMatchPredictionHomePage> createState() =>
      _LiveMatchPredictionHomePagePageState();
}

class _LiveMatchPredictionHomePagePageState
    extends State<LiveMatchPredictionHomePage> {
                            ...
                            children: [
                              Expanded(
                                child: GetBuilder<QuizController>(
                                    init: QuizController(),
                                    builder: (controller) {
                                      return controller.getQuizByMatchId == null
                                          ? shimerEffect(
                                              length: 5, context: context)
                                          : controller.getQuizByMatchId!.data
                                                      .length ==
                                                  0
                                              ? Center(
                                                  child: Text(
                                                      "There is No Any Quiz"),
                                                )
                                              : ListView.builder(
                                                                        ...
                                                                        InkWell(
                                                                          onTap:
                                                                            ...
                                                                            showModalBottomSheet(
                                                                                ...
                                                                                context: context,
                                                                                builder: (context) {
                                                                                  return QuizDetailsBottomSheet(quizData: controller.getQuizByMatchId!.data[index], flag: 'yes');
                                                                                }).then((value) {
                                                                                  debugger();
                                                                        ...
                                                                        InkWell(
                                                                          onTap:
                                                                            ...
                                                                            showModalBottomSheet(
                                                                                ...
                                                                                context: context,
                                                                                builder: (context) {
                                                                                  return QuizDetailsBottomSheet(quizData: controller.getQuizByMatchId!.data[index], flag: 'no');
                                                                                }).then((value) {
                                                                              controller.quizDetailsTimer!.cancel();
                                                                                controller.getQuizListByMatchId(widget.matches.matchId.toString());
                                                                            });
